...
print("################Test 3#####################")
result3 = orchestrator("Hello, I am going to attend a party and would like some suggestions for a midi dress that's available in stock. What can you recommend me?")
print(result3)
print("----------------------------------------")